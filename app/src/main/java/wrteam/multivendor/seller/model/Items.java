...
public class Items implements Serializable {
    String id, user_id, order_id, product_name, variant_name, product_variant_id, delivery_boy_id, quantity, price, discounted_price, tax_amount, tax_percentage, discount, sub_total, active_status, date_added, seller_id, is_credited, variant_id, name, image, manufacturer, made_in, return_status, cancelable_status, till_status, measurement, unit, seller_name, seller_store_name, delivery_boy_name, return_days;
    ...
    public void setIs_credited(String is_credited) {
        this.is_credited = is_credited;
    }
